...
if (Test-Path -LiteralPath $unitIndexPath) {
    ...
    $unitBundleCurrent = $unitMetadata.weapon_runtime_version -eq 5 -and $unitMetadata.movement_runtime_version -eq 1 -and $unitMetadata.feature_runtime_version -eq 5 -and $unitMetadata.ui_runtime_version -eq 1
}
