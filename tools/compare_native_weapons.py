...
def main():
    ...
    report = dict(cases=len(reference['cases']), mismatches=len(differences), exe_sha256=reference['exe_sha256'],
                  scope='Weapon velocity, start velocity, acceleration, turn rate, reload, burst-rate and minimum barrel angle text conversion for 193 bundled definitions plus supplied boundary cases; excludes firing schedule and projectile simulation', differences=differences)
