...
Next: reusable unit/model instances, a local original-data bundle for buildable units, and construction/resource simulation. Work toward an actual playable skirmish loop while continuing native terrain/collision research. Do not describe the provisional A* and sampled height as faithful original navigation. Pitch remains zero; map feature collision, class-vs-FBI rules, terrain projection, full factions, combat and economy remain unfinished.
