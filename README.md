...
Use **Start opponent** to add an enemy builder on Comet Catcher. It builds power and a factory, produces units and attacks. Build your own army to defend the Commander. This is an opt-in development scenario with provisional AI; eliminating all enemy units wins, losing the Commander ends the battle, and the result dialog offers Restart. [Opponent scope](analysis/OPPONENT.md).
