...
func _initialize() -> void:
	...
	var report := {"exe_sha256": trace.exe_sha256, "cases": trace.cases.size(), "mismatches": mismatches,
		"scope": "Flash/Raider/Stumpy/Hammer/Peewee/Rocko/Warrior/Samson/Jethro original axis conversion, full dirty vertex update and SweetSpot wrapper with firing snapshots at four headings; synthetic name ordering; excludes cache timing"}
	if roster:
